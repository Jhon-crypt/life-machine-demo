                    ...
                    <div className="flex flex-wrap -m-8">
                        <div className="w-full md:w-1/3 p-8">
                            <div className="relative text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Platform</h3>
                                    <p className="font-sans text-gray-600"></p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="relative text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Cpu</h3>
                        ...
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Motherboard</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Cooler</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Memory</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Storage 1</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Storage 2</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Gpu</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Psu</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Accessory Bundle 1</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 p-8">
                            <div className="text-center">
                                ...
                                <div className="md:max-w-xs mx-auto">
                                    <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">Accessory Bundle 2</h3>
                                    <p className="font-sans text-gray-600">Lorem ipsum dolor sit amet, consec tetur adipiscing elit volutpat.</p>
                                </div>
                            </div>
                        </div>
